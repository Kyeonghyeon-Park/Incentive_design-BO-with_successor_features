...
parser.add_argument("--update_freq", type=int, default=5, help="Update frequency (update the network per n episodes")
...
parser.add_argument("--hidden_cell_size", type=int, default=128, help="Size of hidden layer")
parser.add_argument("--env_repeat_num", type=int, default=4, help="Number of running roll_out per episode")
