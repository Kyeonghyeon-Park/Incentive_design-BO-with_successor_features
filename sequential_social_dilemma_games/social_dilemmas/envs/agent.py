...
class CleanupAgentModified(CleanupAgent):
    def __init__(self, agent_id, start_pos, start_orientation, full_map, view_len, lv_penalty, lv_incentive):
    ...
    def clean(self, char):
        """Defines how an agent who clean the river gets the reward and the feature"""
        if char == b"C":
